...
gPats = [
  ...
  [  "I am here if you want to share anything.",
    ...
    "Would you prefer listening to a song or maybe talk to a friend?"]],

  [r'(.*)happy',
  [  "I am happy for you too.",
    "Happiness increases if you spread it.",
    "Do you want to note it down for remembering in future?",
    "Would you like to listen to some funny jokes?",
    ]],

    [r'(.*)angry',
    [  "Hey, Drink some water",
     "Analyse your situation , vent out your anger to someone or me if you want?",
     "Try to distract yourself from the reason"
    ]],

    [r'(.*)surprise(.*)',
    [  "What is the reason for it?"
       "Categorize in good as well as bad."
